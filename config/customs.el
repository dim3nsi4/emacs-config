 ...
 '(package-selected-packages
   (quote
    (ag all-the-icons all-the-icons-dired anzu auto-compile avy
     ...
     gradle-mode groovy-mode helm help-fns+ helpful
     company-auctex auctex ivy-xref ag all-the-icons
     highlight-symbol hl-anything hydra image+ ivy ivy-purpose
     ivy-rich java-snippets lua-mode magithub markdown-mode
