...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (ag all-the-icons all-the-icons-dired anzu auctex
     auto-compile autodisass-java-bytecode avy cdlatex
     company-auctex company-bibtex company-jedi company-quickhelp
     counsel counsel-gtags counsel-projectile crux define-word
     diff-hl diminish dired-avfs dired-collapse dired-du
